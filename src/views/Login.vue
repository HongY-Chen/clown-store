<template>
  <div class="login">
    ...
    <img class="logo" src="../assets/clown.png" >
    ...
    <div v-if="type == 'login'" class="login-body login">
      <van-form @submit="onSubmit">
        ...
        <div style="margin: 16px;">
          ...
          <van-button round block type="info" color="#4286d3" native-type="submit">登录</van-button>
        </div>
      </van-form>
    </div>
    ...
    <div v-else class="login-body register">
      <van-form @submit="onSubmit">
        ...
        <div style="margin: 16px;">
          ...
          <van-button round block type="info" color="#4286d3" native-type="submit">注册</van-button>
        </div>
      </van-form>
    </div>
  </div>
